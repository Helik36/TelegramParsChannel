...
1.1 Версия без бота - Done
1.2 Версия с доп. ботом, как админ панель (фильтр слов/предложений) - Done
1.3 Версия с доп.ботом как админ панель + модеация комментариев
