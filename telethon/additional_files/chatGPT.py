...
async def rewrite(my_text):
    ...
    prompt = (
        "Твоя задача -  небольшой рерайт текста, буквально пару изменений. "
        # "Стиль - новостной пост в Телеграмм канале по Играм, Кино и ПК технике."
        ...
        "Текст должен быть сдержанным/нейтральным"
        ""
        f"{my_text}")
